...
public class TermuxFloatAppSharedPreferences extends AppSharedPreferences {
    ...
    public int getFontSize() {
        int fontSize = SharedPreferenceUtils.getIntStoredAsString(mSharedPreferences, (mProperties.isDesktopMode() ? TERMUX_FLOAT_APP.KEY_FONTSIZE_TABLET : TERMUX_FLOAT_APP.KEY_FONTSIZE), DEFAULT_FONTSIZE);
